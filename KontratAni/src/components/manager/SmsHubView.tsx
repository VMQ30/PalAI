...
const statusConfig: Record<
  FarmerSmsStatus,
  { label: string; color: string; mapColor: string }
> = {
  pending: {
    label: "Pending",
    color: "bg-muted text-muted-foreground",
    mapColor: "bg-muted-foreground/30",
  },
  notified: {
    label: "SMS Sent",
    color: "bg-sand/20 text-sand-foreground border-sand/40",
    mapColor: "bg-sand",
  },
  confirmed: {
    label: "Confirmed",
    color: "bg-accent text-accent-foreground",
    mapColor: "bg-secondary",
  },
  planted: {
    label: "Planted",
...
const BROADCAST_TEMPLATES = [
  {
    ...
    en: `[PalAi] Good news! Clear skies expected this week. Great conditions for planting and field work. Stay hydrated. 🌤️`,
    tl: `[PalAi] Magandang balita! Maliwanag ang kalangitan ngayong linggo. Mainam para sa pagtatanim at gawaing bukid. Uminom ng maraming tubig. 🌤️`,
  },
  {
    key: "weather_rain",
    label: "🌧️ Rain Alert",
    en: `[PalAi] Rain alert! Heavy rains expected in the next 2-3 days. Secure your crops and check drainage. 🌧️`,
    tl: `[PalAi] Babala sa ulan! Malakas na ulan inaasahan sa susunod na 2-3 araw. Pangalagaan ang pananim at suriin ang drainage. 🌧️`,
  },
  {
    key: "weather_typhoon",
    label: "⛈️ Typhoon Warning",
    en: `[PalAi] TYPHOON WARNING. A typhoon may affect your area. Harvest what you can and prepare for strong winds. Stay safe! ⛈️`,
    tl: `[PalAi] BABALA SA BAGYO. Maaaring maapektuhan ang inyong lugar. Mag-ani na ng makakaya at maghanda sa malakas na hangin. Mag-ingat! ⛈️`,
  },
  {
    key: "weather_drought",
    label: "🌵 Dry Spell",
    en: `[PalAi] Dry spell advisory. Little to no rain expected for 2 weeks. Prioritize irrigation and water conservation. 🌵`,
    tl: `[PalAi] Payo sa tagtuyot. Kaunti o walang ulan sa susunod na 2 linggo. Unahin ang patubig at pag-iimpok ng tubig. 🌵`,
  },
  {
    key: "crop_reminder",
    label: "📋 Crop Reminder",
    en: `[PalAi] Reminder: Please update your crop status. Thank you!`,
    tl: `[PalAi] Paalala: Mangyaring i-update ang inyong pananim. Salamat!`,
  },
  {
    key: "payment_update",
    label: "💰 Payment Update",
    en: `[PalAi] Good news! Payment for your delivered crops is being processed. You will receive your payout within 24-48 hours. 💰`,
    tl: `[PalAi] Magandang balita! Pinoproseso na ang bayad para sa inyong pananim. Matatanggap ninyo ito sa loob ng 24-48 oras. 💰`,
  },
];
...
export function SmsHubView() {
  ...
  const activeTemplate = BROADCAST_TEMPLATES.find(
          ...
          geometry: {
            ...
            coordinates: [
              [
                ...
                [
                  shiftedCenter.longitude + plotSize + offset,
                  shiftedCenter.latitude,
                ],
                [
                  shiftedCenter.longitude + plotSize + offset,
                  shiftedCenter.latitude + plotSize,
                ],
                [
                  shiftedCenter.longitude + offset,
                  shiftedCenter.latitude + plotSize,
                ],
                [shiftedCenter.longitude + offset, shiftedCenter.latitude],
              ],
  ...
  const smsStats = {
    ...
    confirmed: farmers.filter((f) =>
      ["confirmed", "planted", "harvested"].includes(f.smsStatus),
    ).length,
    planted: farmers.filter((f) =>
      ["planted", "harvested"].includes(f.smsStatus),
    ).length,
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Broadcast and track farmer responses.
          </p>
        </div>
        <Card>
    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Broadcast SMS and monitor farmer planting status.
          </p>
        </div>
        <Button
        ...
        <CardContent className="space-y-3">
          ...
          <div>
            ...
            <p className="mt-1 text-[10px] text-muted-foreground">
              {editableMessage.length} characters · farmers will receive this
              exactly as typed
            </p>
          </div>
        </CardContent>
      ...
      <div className="grid grid-cols-5 gap-3">
        {[
          ...
          {
            label: "SMS Sent",
            value: smsStats.notified,
            color: "text-sand-foreground",
          },
          {
            label: "Confirmed",
            value: smsStats.confirmed,
            color: "text-secondary",
          },
          { label: "Planted", value: smsStats.planted, color: "text-primary" },
          {
            label: "Harvested",
            value: smsStats.harvested,
            color: "text-forest",
          },
        ].map((s) => (
          <Card key={s.label}>
